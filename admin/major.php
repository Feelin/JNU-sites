...
<body>
  ...
  <div class="navbar-inner">
    ...
    <ul class="nav">
      ...
      <li class="active"><a href="major.php">学习考试</a></li>
...
<?php
	...
	$sql ="SELECT * FROM  `major` ORDER BY num;";	
...
<div class="content">
  ...
  <?php
    ...
    <td>".$row['weburl']."</td>
    <td>".$row['kind']."</td>
    <td><a class='up' href='../admin/sortFix.php?type=major&sort=up&id=".$row["num"]."'><i class='icon-circle-arrow-up'></i></a></td>
    <td><a class='down' href='../admin/sortFix.php?type=major&sort=down&id=".$row["num"]."'><i class='icon-circle-arrow-down'></i></a></td>
...
<form class="form-inline" action="edit.php" method="get">
      ...
      <div class="input-prepend">
        <span class="add-on">类别</span>
         <select name="kind">
  <?php
    $sql="SELECT * FROM  `checktype` WHERE  `type` LIKE  'major';";
    $result = mysql_query($sql);  
    while($row = mysql_fetch_array($result)){
  ...
  ?>
      ...
      <input name="type" id="do" type="hidden" value="major"/>
