...
<body>
  ...
  <div class="navbar-inner">
    ...
    <ul class="nav">
      ...
      <li  class="active"><a href="hobby.php">爱好兴趣</a></li>
...
<?php
	...
	$sql ="SELECT * FROM  `hobby` ORDER BY num;";	
...
<div class="content">
  ...
  <?php
    ...
    <td>".$row['weburl']."</td>
    <td>".$row['kind']."</td>
    <td><a class='up' href='../admin/sortFix.php?type=hobby&sort=up&id=".$row["num"]."'><i class='icon-circle-arrow-up'></i></a></td>
    <td><a class='down' href='../admin/sortFix.php?type=hobby&sort=down&id=".$row["num"]."'><i class='icon-circle-arrow-down'></i></a></td>
...
<?php
  $sql="SELECT * FROM  `checktype` WHERE  `type` LIKE  'hobby';";
  $result = mysql_query($sql);  
  while($row = mysql_fetch_array($result)){
...
?>
      ...
      <input name="type" id="do" type="hidden" value="hobby"/>
